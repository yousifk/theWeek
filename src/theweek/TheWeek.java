...
public class TheWeek {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Integer> MapData6 = new HashMap<>();
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("D:\\data.csv"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (Integer.parseInt(ItemColumn[4]) > 0) {
                    ...
                    for (int i = 0; i < Integer.parseInt(ItemColumn[3]) - Integer.parseInt(ItemColumn[4]); i++) {
                        data2.add(Long.toString(time + Integer.parseInt(ItemColumn[3]) * 1000 + i * 1000));
                    }
                }
                ...
                MapData6.put(ItemColumn[1], Integer.parseInt(ItemColumn[3]));
            ...
            Object reLongestTime = Collections.max(NewMapData6.entrySet(), Map.Entry.comparingByValue()).getValue();
            Object reLongestTimeUUID = Collections.max(NewMapData6.entrySet(), Map.Entry.comparingByValue()).getKey();
